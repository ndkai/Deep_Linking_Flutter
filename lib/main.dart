...
import 'deep_linking/params.dart';
...
class _MainScreenState extends State<_MainScreen> {
  ...
  final String Link = 'https://testdeeplink11.page.link/bFkn';
  ...
  Future<void> _createDynamicLink(bool short) async {
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: 'https://testdeeplink11.page.link',
      longDynamicLink: Uri.parse(
        'https://testdeeplink11.page.link/?efr=0&ibi=io.invertase.testing&apn=com.example.deep_linking&imv=0&amv=0&link=https%3A%2F%2Ftest-app%2Fhelloworld&ofl=https://ofl-example.com',
      ),
